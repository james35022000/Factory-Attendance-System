...
<div class="container">
  ...
  <div class="row">
	...
	<?php require_once('db.php');
		$ID = $_GET['ID'];
		$DATE = $_GET['DATE'];
		if(mysql_query("UPDATE `canwall_test`.`Attendance` SET `Approval` = '1' WHERE `Attendance`.`ID` = '$ID' AND `Attendance`.`Date` = '$DATE';")) {  ?>
			<div class="col-lg-4" style="font-size:150%">批准完成</div>
	<?php 
		}  
		else { ?>
			<div class="col-lg-4" style="font-size:150%">批准失敗，請稍後再試</div>
	<?php 
		} ?>
