    ...
    <div class="col-lg-10">
      <!--區塊功能打在這-->
		<div class="row">
			...
			require_once('db.php');
			$query2 = mysql_query(
			"SELECT a1.ID, a2.prior, a1.Shift, a1.Absence, a1.Approval, a1.Date
			FROM Attendance a1, test a2 
			where a1.Date >= '$inputdate1'
			  AND a1.Date <= '$inputdate2'
			  AND a1.ID = a2.id ORDER BY a1.Date, a1.ID"); ?>
			  
			 <div class="row">
				<div class="col-lg-3"><?php print '<font size="5"><b>日期</b></font>'; ?></div>
			...
			<?php while ($row = mysql_fetch_assoc($query2)) { ?>
			  <div class="row">
				<div class="col-lg-3"><?php print $row['Date']; ?></div>
