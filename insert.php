      ...
      <!--區塊功能打在這-->
		<div class="row">
			<form id="insert_done" action="insert_done.php" method="post"> 
				<div class="row"><?php print '<font size="5"><b>輸入欲新增之員工id</b></font>'; ?></div>
				<br>
				<div>
					<input name = "insert_id" type="text" class="form-control" id="insert_id" style="width:80%;" required/>
			    </div>
				<br>
				<div>
				    <input type="submit" class="btn btn-sm btn-info" id="insert_done" value="確定" />
				</div>
			</form>
		</div>
	</div>
